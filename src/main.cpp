...
const char *wifi_ssid = "OPPO Reno6 5G";
const char *wifi_password = "merciari";
...
void setup()
{
  ...
  // ...
  if (mqtt_client.connect(client_id, mqtt_user, mqtt_user))
  {
    mqtt_client.publish("TD02_GP04/temp", String(temp_measure).c_str());
    mqtt_client.publish("TD02_GP04/relhum", String(relative_humidity_measure).c_str());
  }
